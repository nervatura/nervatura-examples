...
class CsvReportWidget extends StatelessWidget {
  const CsvReportWidget({super.key});

  static const routeName = 'csv_report';
  ...
  Widget build(BuildContext context) {
    final ctr = Provider.of<CsvReportController>(context);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(ctr.labels('csvReport')),
        centerTitle: true,
      ),
      body: ListView(
        shrinkWrap: true,
            ...
            child: Card(
              child: Container(
                constraints: const BoxConstraints(
                    maxWidth: 900, maxHeight: double.infinity),
                padding: const EdgeInsets.all(24),
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Text(ctr.labels('csvReport'),
